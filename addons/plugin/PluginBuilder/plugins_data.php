...
return array (
	...
	array (
		...
		array (
			...
			array (
				'comment' => '添加首页左侧的链接',
				'name' => 'home_index_left_tab',
				'content' => '		$url =	Addons::createAddonShow(\'Radio\',\'index\',array());
		...
		$this->display(\'create\');',
			...
			array (
				'comment' => '使用相关',
				'name' => 'ask',
				'content' => '		$this->display(\'ask\');',
			),
			5 => 
			array (
				'comment' => '电台首页',
				'name' => 'index',
				'content' => '		$type = (isset($_GET[\'id\'])) ? abs(intval($_GET [\'id\'])) :(($_COOKIE[\'radio_type\'])?$_COOKIE[\'radio_type\']:0);
		...
		if(isset($_POST[\'id\'])){//编辑
			...
			array (
				'comment' => '上传图片',
				'name' => 'upload_image',
				'content' => '		if(is_uploaded_file($param[\'tmp_name\'])){
		...
		array (
			0 => 
			array (
				'method' => 'home_index_left_tab',
				'hook' => 'home_index_left_tab',
			),
		),
		'start' => '',
		'install' => '		 $oldTypeArray = array (
		...
		return true;',
		'uninstall' => '',
		'adminMenu' => 'admin:电台管理,create:新建电台,ask:使用相关',
	),
);