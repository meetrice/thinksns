...
return array (
  ...
  array (
    ...
    array (
      ...
      'attach_allow_extension' => '单个输入后按enter键分割',
    ),
    'key_javascript' => 
    array (
      'attach_path_rule' => '',
  ...
  array (
    ...
    array (
      ...
      'user_group_type' => '普通组将与其他组权限合并，特殊组将覆盖其他组权限',
      'is_authenticate' => '',
    ),
    'key_javascript' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'des' => '',
      'pic' => '最佳图片大小为620*200',
      'topic_user' => '最多设置9个人物推荐',
      'outlink' => '',
      'recommend' => '最多设置10个热门话题',
      'essence' => '最多设置3个精华话题',
    ),
    'key_javascript' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'verified_category_id' => 'verified_category_id',
      'company' => 'company',
      'realname' => 'realname',
      'idcard' => 'idcard',
      'phone' => 'phone',
  ...
  array (
    ...
    array (
      ...
      'read_count/reply_count' => '浏览数/回复数',
      'weiba_id' => '所属微吧ID',
      'DOACTION' => '操作',
    ),
    'key_hidden' => 
  ...
  array (
    ...
    'key_tishi' => 
    array (
      'send_email_num' => '已经配好了，不要随便更改',
      'send_link_num' => '已经配好了，不要随便更改',
    ),
    'key_javascript' => 
    array (
      'send_email_num' => '',
  ...
  array (
    ...
    array (
      ...
      'site_name' => 'text',
      'site_slogan' => 'text',
      'site_header_keywords' => 'hidden',
      'site_header_description' => 'hidden',
      'site_company' => 'hidden',
      'site_footer' => 'text',
      'site_logo' => 'image',
      'login_bg' => 'image',
    ...
    array (
      ...
      'site_logo' => '推荐规格：120x40',
      'login_bg' => '推荐规格：1280x800，适应屏幕大一些最好',
      'site_closed_reason' => '',
      'sys_domain' => '单个输入后按enter键分割',
      'sys_nickname' => '单个输入后按enter键分割',
      'sys_email' => '',
      'home_page' => '登陆后跳转到该页面（可设置跳转到微吧、频道等应用）',
      'sys_version' => '修改了JS、CSS等静态文件后最好更新一下',
      'site_online_count' => '使用第三方统计时可关闭',
  ...
  array (
    ...
    array (
      'register_type' => '',
      'email_suffix' => '只允许以上后缀的邮箱注册站点，输入后按enter键分割，如“@qq.com,@sina.com”',
      'captcha' => '',
      'register_audit' => '',
      'need_active' => '',
      'photo_open' => '',
    ...
    'key_javascript' => 
    array (
      'register_type' => 'admin.registerConfig(this.value)',
      'email_suffix' => '',
      'captcha' => '',
      'register_audit' => '',
      'need_active' => '',
  ...
  array (
    ...
    array (
      'cachetype' => '',
      'cachesetting' => '根据不同的缓存类型进行配置，如：memcache可配置成127.0.0.1：11211，使用默认IP和端口不需要配置',
      'status' => '',
    ),
    'key_javascript' => 
    array (
